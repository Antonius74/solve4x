...
const presets = [
  ...
  {
    expressions: ["0.6*cos(x) + 0.6*cos(y)", "0.07*(x^2 + y^2)"],
    xMin: -10,
    xMax: 10,
    yMin: -10,
    yMax: 10,
  ...
  {
    expressions: ["sin(0.7*x)*sin(0.7*y)", "0.05*(x*y)"],
    xMin: -14,
    xMax: 14,
    yMin: -14,
    yMax: 14,
  ...
  },
  {
    ...
    zScale: "linear",
    colorMap: "Turbo",
    params: { a: 2.5, b: 2, s: 9 },
  },
  {
    expressions: ["0.03*(x^3 - 3*x*y^2)", "-0.03*(y^3 - 3*x^2*y)"],
    xMin: -10,
    xMax: 10,
    yMin: -10,
    yMax: 10,
  ...
  {
    expressions: ["0.6*atan(x*y)", "0.2*sin(x+y)"],
    xMin: -10,
    xMax: 10,
    yMin: -10,
    yMax: 10,
  ...
  {
    expressions: ["(sin(x)+sin(y))/2", "0.12*cos(x-y)"],
    xMin: -12,
    xMax: 12,
    yMin: -12,
    yMax: 12,
